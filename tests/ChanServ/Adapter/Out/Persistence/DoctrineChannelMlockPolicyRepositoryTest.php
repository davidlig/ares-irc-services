...
use App\ChanServ\Adapter\Out\Persistence\DoctrineChannelMlockPolicyRepository;
...
#[CoversClass(DoctrineChannelMlockPolicyRepository::class)]
final class DoctrineChannelMlockPolicyRepositoryTest extends TestCase
{
    #[Test]
    public function itNormalizesLookupAndLoadsOnlyTheMlockPolicySnapshot(): void
    {
        ...
        $policy = new DoctrineChannelMlockPolicyRepository($channels)->findByName('#CASE');
    ...
    public function itReturnsNullWhenTheChannelIsUnknown(): void
    {
        ...
        self::assertNull(new DoctrineChannelMlockPolicyRepository($channels)->findByName('#missing'));
    }
