...
use App\ChanServ\Adapter\Out\Persistence\LegacyChannelRankPolicyRepository;
...
#[CoversClass(LegacyChannelRankPolicyRepository::class)]
final class LegacyChannelRankPolicyRepositoryTest extends TestCase
{
    #[Test]
    public function itNormalizesLookupAndLoadsOnlyTheRankPolicySnapshot(): void
    {
        ...
        $policy = new LegacyChannelRankPolicyRepository($channels, $access, $levels)->findByName('#CASE');
    ...
    public function itReturnsNullWithoutLoadingRankCollectionsWhenTheChannelIsUnknown(): void
    {
        ...
        self::assertNull(new LegacyChannelRankPolicyRepository($channels, $access, $levels)->findByName('#missing'));
    }
    ...
    public function itMapsAllRankPolicies(): void
    {
        ...
        $policies = new LegacyChannelRankPolicyRepository($channels, $access, $levels)->all();
    ...
    private function repository(RegisteredChannelRepositoryInterface $channels): LegacyChannelRankPolicyRepository
    {
        return new LegacyChannelRankPolicyRepository(
            $channels,
