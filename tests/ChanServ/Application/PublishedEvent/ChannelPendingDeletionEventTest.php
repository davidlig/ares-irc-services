...
#[CoversClass(ChannelPendingDeletionEvent::class)]
final class ChannelPendingDeletionEventTest extends TestCase
{
    #[Test]
    public function constructionAndProperties(): void
    {
        $at = new DateTimeImmutable('2026-09-19 13:36:00');
        $event = new ChannelPendingDeletionEvent(7, '#Test2', '#test2', 'OperNick', $at);
    ...
    {
        $event = new ChannelPendingDeletionEvent(7, '#Test2', '#test2', null, new DateTimeImmutable());
