...
use App\ChanServ\Application\Service\NickChannelAssociationQueryService;
...
#[CoversClass(NickChannelAssociationQueryService::class)]
#[CoversClass(NickChannelAssociation::class)]
final class NickChannelAssociationQueryServiceTest extends TestCase
{
    #[Test]
    public function returnsEmptyArrayWhenNoChannelsOrAccessEntriesFound(): void
    {
        ...
        $query = new NickChannelAssociationQueryService($accessRepo, $channelRepo);

        self::assertSame([], $query->findForNick(123));
    }
