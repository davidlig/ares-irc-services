...
#[CoversClass(ActiveConnectionCommandAuditPresenter::class)]
final class ActiveConnectionCommandAuditPresenterTest extends TestCase
{
    #[Test]
    public function presentsOnlyToConfiguredServiceDebugChannel(): void
    {
        ...
        new ActiveConnectionCommandAuditPresenter(new ServiceDebugNotifierRegistry([$notifier]))->present(
    ...
    public function ignoresUnknownOrUnconfiguredServiceWithoutPresenting(): void
    {
        ...
        $presenter = new ActiveConnectionCommandAuditPresenter(new ServiceDebugNotifierRegistry([$notifier]));
