...
use App\OperServ\Adapter\Out\Projection\DoctrineOperatorNetworkProjectionQuery;
...
#[CoversClass(DoctrineOperatorNetworkProjectionQuery::class)]
#[CoversClass(OperatorNetworkProjection::class)]
final class DoctrineOperatorNetworkProjectionQueryTest extends TestCase
{
    #[Test]
    public function returnsNullWhenTheNickHasNoOperatorAssignment(): void
    {
        ...
        self::assertNull(new DoctrineOperatorNetworkProjectionQuery($repository)->findForNick(42, 'Alice'));
    }
    ...
    public function returnsEveryNickIdAssignedToTheRole(): void
    {
        ...
        self::assertSame(
            [42, 84],
            new DoctrineOperatorNetworkProjectionQuery($repository)->findNickIdsByRoleId(7),
        );
    }
}
