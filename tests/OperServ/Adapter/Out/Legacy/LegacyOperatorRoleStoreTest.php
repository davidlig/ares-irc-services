...
use App\OperServ\Adapter\Out\Legacy\LegacyOperatorRoleStore;
...
#[CoversClass(LegacyOperatorRoleStore::class)]
#[CoversClass(OperatorRoleRecord::class)]
final class LegacyOperatorRoleStoreTest extends TestCase
{
    #[Test]
    public function findsAndListsCompleteRoleRecords(): void
    {
        ...
        $store = new LegacyOperatorRoleStore($roles, $this->createStub(OperPermissionRepositoryInterface::class));
    ...
    public function preservesAMissingRole(): void
    {
        ...
        self::assertNull(new LegacyOperatorRoleStore(
            $roles,
    ...
    public function createsAndPersistsAMissingPermissionBeforeSavingTheRoleAssociation(): void
    {
        ...
        new LegacyOperatorRoleStore($roles, $permissions)->setPermissions('ADMIN', ['operserv.global']);
    ...
    public function reusesAnExistingPermissionWithoutPersistingItAgain(): void
    {
        ...
        new LegacyOperatorRoleStore($roles, $permissions)->setPermissions('ADMIN', ['operserv.kill']);
    ...
    public function replacesPreviouslyAssociatedPermissions(): void
    {
        ...
        new LegacyOperatorRoleStore($roles, $permissions)->setPermissions('ADMIN', ['operserv.raw']);
