...
use App\OperServ\Adapter\Out\Legacy\LegacyOperatorAssignmentStore;
...
#[CoversClass(LegacyOperatorAssignmentStore::class)]
#[CoversClass(OperatorAssignmentRecord::class)]
#[CoversClass(OperatorRoleRecord::class)]
final class LegacyOperatorAssignmentStoreTest extends TestCase
{
    #[Test]
    ...
    public function persistsANewAssignmentWithTheResolvedRole(): void
    {
        ...
        new LegacyOperatorAssignmentStore($assignments, $roles)->assign(
            42,
    ...
    public function rejectsAnAssignmentWhenItsRoleDisappeared(): void
    {
        ...
        $roles = $this->createStub(OperRoleRepositoryInterface::class);
        new LegacyOperatorAssignmentStore(
    ...
    private function store(OperIrcopRepositoryInterface $assignments): LegacyOperatorAssignmentStore
    {
        return new LegacyOperatorAssignmentStore(
            $assignments,
