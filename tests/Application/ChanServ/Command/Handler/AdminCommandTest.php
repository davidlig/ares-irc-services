...
final class AdminCommandTest extends TestCase
{
    ...
    public function replyInvalidChannelWhenFirstArgNotChannel(): void
    {
        ...
        $cmd = new AdminCommand($channelRepo, $nickRepo, $userLookup, $accessHelper);
    ...
    #[Test]
    public function successSetsAdminModeAndReplies(): void
    {
        ...
        self::assertSame(['#test', 'UID2', 'a', true], $modeCalls[0]);
    }
}
