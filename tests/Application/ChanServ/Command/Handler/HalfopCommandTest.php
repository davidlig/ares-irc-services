...
final class HalfopCommandTest extends TestCase
{
    /**
     * @param string[] $args
     */
    ...
    #[Test]
    public function successSetsHalfopModeAndReplies(): void
    {
        ...
        self::assertSame(['halfop.done'], $messages);
        self::assertSame(['#test', 'UID2', 'h', true], $modeCalls[0]);
    }

    #[Test]
    public function replyNotSupportedWhenIrcdDoesNotSupportHalfop(): void
    {
        $channelRepo = $this->createStub(RegisteredChannelRepositoryInterface::class);
        $nickRepo = $this->createStub(RegisteredNickRepositoryInterface::class);
        $userLookup = $this->createStub(NetworkUserLookupPort::class);
    ...
    public function replyErrorWhenSecureChannelAndTargetInsufficientLevel(): void
    {
        ...
        $senderAccess->method('getLevel')->willReturn(200);
    ...
    #[Test]
    public function getNameReturnsHalfop(): void
    {
        ...
        self::assertSame('HALFOP', $cmd->getName());
    }
    ...
    #[Test]
    public function getSyntaxKeyReturnsHalfopSyntax(): void
    {
        $cmd = new HalfopCommand(
            $this->createStub(RegisteredChannelRepositoryInterface::class),
            $this->createStub(RegisteredNickRepositoryInterface::class),
        ...
        self::assertSame('halfop.syntax', $cmd->getSyntaxKey());
    }

    #[Test]
    public function getHelpKeyReturnsHalfopHelp(): void
    {
        $cmd = new HalfopCommand(
            $this->createStub(RegisteredChannelRepositoryInterface::class),
            $this->createStub(RegisteredNickRepositoryInterface::class),
        ...
        self::assertSame('halfop.help', $cmd->getHelpKey());
    }
    ...
    #[Test]
    public function getShortDescKeyReturnsHalfopShort(): void
    {
        $cmd = new HalfopCommand(
            $this->createStub(RegisteredChannelRepositoryInterface::class),
            $this->createStub(RegisteredNickRepositoryInterface::class),
        ...
        self::assertSame('halfop.short', $cmd->getShortDescKey());
    }
