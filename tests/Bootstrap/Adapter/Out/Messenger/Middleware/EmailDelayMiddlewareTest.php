...
namespace App\Tests\Bootstrap\Adapter\Out\Messenger\Middleware;

use App\Bootstrap\Adapter\Out\Messenger\Middleware\EmailDelayMiddleware;
use App\Shared\Application\Mail\Message\SendEmail;
