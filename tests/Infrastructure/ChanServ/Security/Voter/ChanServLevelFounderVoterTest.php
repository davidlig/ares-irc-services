...
namespace App\Tests\Infrastructure\ChanServ\Security\Voter;
...
use App\Infrastructure\ChanServ\Security\Voter\ChanServLevelFounderVoter;
...
final class ChanServLevelFounderVoterTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->voter = new ChanServLevelFounderVoter($this->accessHelper, $this->rootRegistry, $this->ircopRepository);
    }
    ...
    public function voteGrantsWhenIrcopHasLevelFounderPermission(): void
    {
        ...
        $roleRepository->expects(self::once())->method('hasPermission')->with(1, ChanServPermission::LEVEL_FOUNDER)->willReturn(true);
        ...
        $voter = new ChanServLevelFounderVoter($accessHelper, $this->rootRegistry, $ircopRepository);
    ...
    public function voteDeniesWhenIrcopLacksLevelFounderPermission(): void
    {
        ...
        $roleRepository = $this->createMock(OperRoleRepositoryInterface::class);
        $roleRepository->expects(self::once())->method('hasPermission')->with(1, ChanServPermission::LEVEL_FOUNDER)->willReturn(false);
    ...
    private function createChanServContext(?SenderView $sender, ?RegisteredNick $account): ChanServContext
    {
