...
#[CoversClass(UnrealUdbServiceIntroductionFormatter::class)]
final class UnrealUdbServiceIntroductionFormatterTest extends TestCase
{
    private UnrealUdbServiceIntroductionFormatter $formatter;

    protected function setUp(): void
    {
        $this->formatter = new UnrealUdbServiceIntroductionFormatter();
    }
