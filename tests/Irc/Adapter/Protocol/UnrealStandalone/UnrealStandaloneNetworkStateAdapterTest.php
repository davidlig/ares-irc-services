...
#[CoversClass(UnrealStandaloneNetworkStateAdapter::class)]
final class UnrealStandaloneNetworkStateAdapterTest extends TestCase
{
    #[Test]
    public function getSupportedProtocolReturnsUnreal(): void
    {
        $adapter = new UnrealStandaloneNetworkStateAdapter(
    ...
    public function handleMessageWithUnknownCommandDispatchesNothing(): void
    {
        ...
        $adapter = new UnrealStandaloneNetworkStateAdapter($eventDispatcher);
