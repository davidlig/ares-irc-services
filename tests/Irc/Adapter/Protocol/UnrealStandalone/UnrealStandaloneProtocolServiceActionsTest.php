...
#[CoversClass(UnrealStandaloneProtocolServiceActions::class)]
final class UnrealStandaloneProtocolServiceActionsTest extends TestCase
{
    ...
    {
        $actions = new UnrealStandaloneProtocolServiceActions($this->connectionHolder);
    ...
    public function methodsDoNothingWhenDisconnected(): void
    {
        ...
        $actions = new UnrealStandaloneProtocolServiceActions($connectionHolder);
