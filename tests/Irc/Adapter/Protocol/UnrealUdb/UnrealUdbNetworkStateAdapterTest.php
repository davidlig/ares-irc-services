...
#[CoversClass(UnrealUdbNetworkStateAdapter::class)]
final class UnrealUdbNetworkStateAdapterTest extends TestCase
{
    #[Test]
    public function getSupportedProtocolReturnsUnreal(): void
    {
        $adapter = new UnrealUdbNetworkStateAdapter(
            $this->createStub(EventDispatcherInterface::class),
        );

        self::assertSame('unrealudb', $adapter->getSupportedProtocol());
    }
    ...
    public function handleMessageWithUnknownCommandDispatchesNothing(): void
    {
        ...
        $adapter = new UnrealUdbNetworkStateAdapter($eventDispatcher);
    ...
    #[Test]
    public function handleSjoinWithExtPrefixNoClosingBracketTriesParseEntry(): void
    {
        $captured = null;
        $eventDispatcher = $this->createMock(EventDispatcherInterface::class);
        $eventDispatcher->expects(self::once())->method('dispatch')
    ...
    #[Test]
    public function handleSjoinWithExtPrefixAndClosingBracketStripsAndParsesUid(): void
    {
        $captured = null;
        $eventDispatcher = $this->createMock(EventDispatcherInterface::class);
        $eventDispatcher->expects(self::once())->method('dispatch')
    ...
    #[Test]
    public function handleSjoinWithoutModesInParams(): void
    {
        $captured = null;
        $eventDispatcher = $this->createMock(EventDispatcherInterface::class);
        $eventDispatcher->expects(self::once())->method('dispatch')
