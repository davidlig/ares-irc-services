...
final class UdbOfflineTakeoverTest extends DoctrineIntegrationTestCase
{
    ...
    {
        $nick = new NickProjection(1, 'alice', '$2y$12$V1fmubjfLQd.sMvEU4x.5.hjN6wtGG1aNhiJqy.dc0O0sfKFzyLGe', null, false, null, false);
    ...
    {
        $nick = new NickProjection(1, "invalid\0nick", '$2y$12$V1fmubjfLQd.sMvEU4x.5.hjN6wtGG1aNhiJqy.dc0O0sfKFzyLGe', null, false, null, false);
        $repository = $this->createStub(NickProjectionQuery::class);
        $repository->method('all')->willReturn([$nick]);
        $this->writeValidGeneration();
