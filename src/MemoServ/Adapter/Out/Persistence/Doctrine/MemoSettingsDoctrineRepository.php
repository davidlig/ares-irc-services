...
final readonly class MemoSettingsDoctrineRepository implements MemoSettingsRepositoryInterface
{
    ...
    {
        $this->em->createQuery(
            'DELETE FROM App\MemoServ\Domain\Entity\MemoSettings s WHERE s.targetNickId = :nickId'
        )
    ...
    {
        $this->em->createQuery(
            'DELETE FROM App\MemoServ\Domain\Entity\MemoSettings s WHERE s.targetChannelId = :channelId'
        )
