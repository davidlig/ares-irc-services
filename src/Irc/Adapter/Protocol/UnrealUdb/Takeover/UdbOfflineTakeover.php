    ...
    public function takeover(string $directory, bool $apply = true): string
    {
        ...
        try {
            ...
            $this->em->wrapInTransaction(function () use ($candidate, $fingerprint): void {
                $this->em->createQuery('DELETE FROM App\Irc\Adapter\Protocol\UnrealUdb\Model\UdbRecord r')->execute();
                $this->em->createQuery('DELETE FROM App\Irc\Adapter\Protocol\UnrealUdb\Model\UdbBlockState s')->execute();
