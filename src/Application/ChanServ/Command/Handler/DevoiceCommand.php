...
final readonly class DevoiceCommand implements ChanServCommandInterface
{
    ...
    /** @return array{string, string, RegisteredChannel, SenderView}|null */
    private function validateDevoiceTarget(ChanServContext $context, RegisteredChannel $channel, string $channelName, string $targetNick, RegisteredNick $senderAccount): ?array
    {
