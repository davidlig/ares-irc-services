...
final readonly class RoleCommand implements OperServCommandInterface
{
    ...
    public function execute(OperServContext $c): void
    {
        ...
        $this->present($c, $sub, $r, $role, $value);
    }
